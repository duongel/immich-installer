...
networks:
  immich_internal:
    driver: bridge
    internal: true  # No internet access for backend services (except via container linking)
  immich_public:
    driver: bridge
...
services:
  ...
  immich-machine-learning:
    ...
    # Using openvino for better CPU performance on Pi if applicable, or default
...
class ImmichInstallerApp:
    ...
    def install_logic(self):
        ...
        try:
            ...
            # IMPORTANT: Since group changes (usermod) require relogin to take effect for the current user,
            # we must run the docker command with sudo this first time.
